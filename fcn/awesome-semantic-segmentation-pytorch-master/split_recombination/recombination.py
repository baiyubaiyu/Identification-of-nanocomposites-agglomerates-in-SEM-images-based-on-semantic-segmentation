...
IMAGES_PATH = '/root/CV_Project/awesome-semantic-segmentation-pytorch-master/runs/pred_pic/psp_resnet50_sem'  # 图片集地址
IMAGES_FORMAT = ['.png', '.PNG']  # 图片格式
IMAGE_SIZE = (480, 640) # 每张小图片的大小
IMAGE_ROW = 2  # 图片间隔，也就是合并成一张图后，一共有几行
IMAGE_COLUMN = 2  # 图片间隔，也就是合并成一张图后，一共有几列
IMAGE_SAVE_PATH = '/root/CV_Project/awesome-semantic-segmentation-pytorch-master/runs/pred_pic/psp_resnet50_sem_recombination'  # 图片转换后的地址
