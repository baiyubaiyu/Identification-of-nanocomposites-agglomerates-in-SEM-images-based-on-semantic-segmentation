...
import numpy as np
img_path = '/root/Data/new_sem/val/images'
mask_path = '/root/Data/new_sem/val/masks'
out_img = '/root/Data/new_sem/split/images'
out_mask = '/root/Data/new_sem/split/masks'
